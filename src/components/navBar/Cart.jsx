      ...
      <span className=" h-[100px] sticky flex items-center justify-start pl-5 cursor-pointer overflow-hidden">
        <span className="rounded-full p-[2px] bg-conic-gradient">
          <IoCloseCircle
            ...
            className="bg-[#0E0C15]/90 rounded-full hover:bg-orange-600 transition-all duration-200 cursor-pointer hover:scale-114"
          />
        </span>
      </span>
              ...
              >
                ...
                <div className="flex flex-col items-center select-none font-vazirmatn uppercase shadow-md">
                  <Image
                    ...
                    alt={item.title || item.plan?.product_entry?.product?.title}
                    width={64}
                    height={64}
