    ...
    <Section crosses>
      <div className="max-w-6xl mx-auto px-5 md:px-10 lg:px-15 xl:max-w-7xl lg:flex min-h-[600px] lg:min-h-[700px] py-12 lg:py-16">
        ...
        <div className="flex flex-col items-center xl:w-[500px] mt-12 lg:mt-25 lg:items-end">
          <div className="font-light text-sm leading-6 md:text-base mb-22 text-[#757185] md:mb-16 lg:mb-3 lg:w-[320px] xl:mr-65 lg:self-start font-vazirmatn lg:mr-20">
            <Heading
              className="scale-100 md:scale-120 font-bold"
              tag={RoadMapText}
            />
          </div>
