...
export default function PlanCards({ data, plan, index }) {
  ...
  return (
    <div className="w-full mt-12 min-h-[200px] md:min-h-[300px] border-[1px] border-gray-200/20  hover:shadow-lg hover:shadow-gray-100/10 hover:translate-y-[-5px] duration-300 ease-in-out shadow-gray-200/20 rounded-lg p-5 flex flex-col justify-start font-vazirmatn">
      <h2 className={`text-extrabold text-4xl font-poppins ${modelColor}`}>
        {data.model}
      </h2>
      <p className="text-gray-500 my-3 font-vazirmatn">{data.description}</p>
